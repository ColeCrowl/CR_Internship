<#
.SYNOPSIS
    This PowerShell script ensures Windows 11 must audit Other Logon/Logoff Events.
...
.USAGE
    .USAGE
    This script remediates the 'WN11-AU-000565' STIG by configuring the 
    specified settings. It should be run with administrative privileges.

    Example syntax:
    PS C:\> .\STIG-WN11-AU-000565_fix.ps1
#>
